...
const About = () => {
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="rounded-lg overflow-hidden shadow-md">
              <img 
                src="https://rupaligroup.net/wp-content/uploads/2023/01/our-mission.jpg"
  ...
  <div className="container mx-auto px-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {[
        { name: 'Shivek yadav', role: 'projects leader', image: './shivek.jpg' },
        { name: 'Raju kumar sahani', image: './raju.jpg' },
        { name: 'Bablu kumar', role: 'Outreach Coordinator', image: './bablu.jpg' },
        { name: 'Mohd Aarif', image: './aaif.jpg' },
      ].map((member, index) => (
